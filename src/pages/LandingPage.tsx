      ...
      <header className='border-b border-border'>
        <div className='container mx-auto px-4 py-4 flex justify-between items-center'>
          ...
          <div className='flex items-center space-x-4'>
            ...
            <Link to='/brand'>
              <Button size='sm'>Try as Brand</Button>
            </Link>
          </div>
        </div>
      </header>
          ...
          <div className='grid md:grid-cols-3 gap-8'>
            <Card>
              <CardContent className='p-6 text-center'>
                ...
                <p className='text-text-secondary'>
                  One tap x402 challenge proves wallet ownership and assigns a role (brand or
                  publisher) on-chain.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className='p-6 text-center'>
                ...
                <p className='text-text-secondary'>
                  AI-powered matching connects relevant ads with publisher audiences based on
                  content tags and wallet reputation.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className='p-6 text-center'>
                ...
                <p className='text-text-secondary'>
                  Publishers receive SOL rewards settled automatically through x402 micro-payments
          ...
          <div className='grid gap-6 lg:grid-cols-2'>
            <Card>
              <CardContent className='p-8 space-y-6'>
                ...
                <p className='text-text-secondary'>
                  Connect a wallet, stake via x402, upload your creative, and go live once
                  moderation + wallet checks pass. Every impression can be traced back to your
                  signing key.
                </p>
                <ul className='space-y-3 text-text'>
                  ...
                  <li className='flex items-start gap-3'>
                    ...
                    Real-time creative dashboard mirrors the component library used in{' '}
                    <code className='text-sm'>/brand</code>.
                  </li>
                </ul>
                <Link to='/brand'>
            ...
            <Card>
              <CardContent className='p-8 space-y-6'>
                ...
                <h3 className='text-2xl font-semibold text-text'>
                  Monetize every slot, automatically
                </h3>
                <p className='text-text-secondary'>
                  Register your domain, drop the SDK snippet, and let{' '}
                  <code className='text-sm'>adx402</code> call{' '}
                  <code className='text-sm'>/ad/&lt;wallet&gt;</code> using your tags and slot
                  reputation. x402 handles payouts—no invoicing.
                </p>
                <ul className='space-y-3 text-text'>
                  <li className='flex items-start gap-3'>
                    <span className='mt-1 h-2 w-2 rounded-full bg-secondary' />
                  ...
                  <li className='flex items-start gap-3'>
                    ...
                    Each impression/click is hashed; once verified, x402 settles SOL directly to
                    your wallet.
                  </li>
                  <li className='flex items-start gap-3'>
      ...
      <section className='py-16 px-4'>
        <div className='container mx-auto max-w-5xl grid gap-8 lg:grid-cols-2'>
          <div className='space-y-4'>
            ...
            <p className='text-text-secondary'>
              x402 brings HTTP status 402 (Payment Required) to Solana. We use it to verify wallets,
              require deposits, and stream rewards—all without centralized accounts.
            </p>
            <ul className='space-y-3 text-text'>
              <li className='flex items-start gap-3'>
                <span className='mt-1 h-2 w-2 rounded-full bg-primary' />
            ...
            <CardContent className='space-y-6 p-6'>
              ...
              <div className='space-y-4 text-sm text-text-secondary'>
                <div className='rounded-lg border border-border p-4'>
                  ...
                  <p className='mt-1'>
                    <code className='text-sm text-text'>adx402</code> requests a signed message to
                    prove wallet ownership via x402 endpoints.
                  </p>
                </div>
                <div className='rounded-lg border border-border p-4'>
                  <p className='text-text font-semibold'>2. Serve & track</p>
                  <p className='mt-1'>
                    Ads render in isolated slots, impressions/clicks are hashed and queued for
                    validation.
                  </p>
                </div>
                <div className='rounded-lg border border-border p-4'>
                  ...
                  <p className='mt-1'>
                    Verified metrics trigger x402 payouts in SOL with transaction hashes auditable
                    on-chain.
                  </p>
                </div>
              </div>
      ...
      <section className='py-16 px-4'>
        <div className='container mx-auto max-w-4xl'>
          <div className='text-center mb-12'>
            <h2 className='text-3xl font-bold text-text mb-4'>Easy Integration</h2>
            <p className='text-xl text-text-secondary'>Drop-in SDK for any website or app</p>
          </div>
...
adx402.render("#ad-slot", {
  aspectRatio: "16x9"
              ...
              <div className='text-center'>
                <Link to='/demo'>
                  <Button variant='outline'>Try the SDK Demo →</Button>
                </Link>
              </div>
            </CardContent>
          </Card>
