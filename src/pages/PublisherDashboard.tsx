    ...
    <div className="min-h-screen bg-background text-text">
      ...
      <main className="container mx-auto px-6 py-8 space-y-8">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-text-secondary">Impressions: {publisher.totalImpressions.toLocaleString()}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <p className="text-text-secondary">Clicks: {publisher.totalClicks.toLocaleString()}</p>
          </CardContent>
          </Card>
        </section>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="slot-id" required>Slot ID (CSS selector)</Label>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {mockMetrics.slice(0, 4).map((metric, index) => (
                <div key={index} className="flex flex-wrap items-center justify-between gap-4 rounded-lg border border-border p-4">
                  <div>
